...
<script src="<?php echo e(asset('/public/web-assets/backend/js/jquery.min.js')); ?>"></script>
<script src="<?php echo e(asset('/public/web-assets/backend/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
<script src="<?php echo e(asset('/public/web-assets/backend/plugins/perfect-scrollbar/perfect-scrollbar.min.js')); ?>"></script>
<script src="<?php echo e(asset('/public/web-assets/backend/plugins/moment/moment.min.js')); ?>"></script>
<script src="<?php echo e(asset('/public/web-assets/backend/plugins/dropzone/dropzone.min.js')); ?>"></script>
<!-- ======= BEGIN GLOBAL MANDATORY SCRIPTS ======= -->
...
<!-- ======= TOASTER ======= -->
<script src="<?php echo e(asset('/public/web-assets/backend/js/toaster.min.js')); ?>"></script>
                ...
                if (is_for_browse_file) {
                    ...
                    for (let i = 0; i < media_files.length; i++) {
                        if (media_files[i].id == id) {
                            ...
                            let media_path = '<?php echo e(project_asset('path')); ?>';
                            ...
                            if ($('#list_item_' + id).hasClass('selected')) {
                                ...
                                selected_file_location['file_' + id] = '<?php echo e(project_asset('/')); ?>' + "/" +
                                    media_files[i].path
                    ...
                    for (let i = 0; i < media_files.length; i++) {
                        if (media_files[i].id == id) {
                            ...
                            $('#file_url').val('<?php echo e(project_asset('/')); ?>' + "\/" + media_files[i].path)
                            $('#download_file').attr('href', '<?php echo e(project_asset('/')); ?>' + "\/" +
                                media_files[i]
                                .path)
                            ...
                            $('#preview_image').attr('src', '<?php echo e(project_asset('/')); ?>' + "\/" +
                                media_files[i]
                                .path)
...
<script src="<?php echo e(asset('/public/web-assets/backend/js/script.js')); ?>"></script>
<?php /**PATH C:\Development\quick-shop\Core/resources/views/base/layouts/script.blade.php ENDPATH**/ ?>